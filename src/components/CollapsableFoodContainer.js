...
const CollapsableFoodContainer = React.memo(props => {
  ...
  return (
    <View>
      ...
      {showDropDown ? null :<View style={styles.childrenContainer}>{children}</View>}
    </View>
  );
});

export default CollapsableFoodContainer;
